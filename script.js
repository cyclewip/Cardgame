$(document).ready(function () {
    ...
    var cards = ["img/2_of_clubs.png", "img/2_of_diamonds.png", "img/2_of_hearts.png", "img/2_of_spades.png", "img/3_of_clubs.png", "img/3_of_diamonds.png",
        "img/3_of_hearts.png", "img/3_of_spades.png", "img/4_of_clubs.png", "img/4_of_diamonds.png", "img/4_of_hearts.png", "img/4_of_spades.png",
        ...
        "img/9_of_spades.png", "img/9_of_hearts.png", "img/10_of_hearts.png", "img/10_of_spades.png", "img/10_of_clubs.png", "img/10_of_diamonds.png", "img/jack_of_clubs.png",
        "img/jack_of_diamonds.png", "img/jack_of_hearts.png", "img/jack_of_spades.png", "img/queen_of_clubs.png", "img/queen_of_diamonds.png", "img/queen_of_hearts.png",
        "img/queen_of_spades.png", "img/king_of_clubs.png", "img/king_of_diamonds.png", "img/king_of_hearts.png", "img/king_of_spades.png", "img/ace_of_clubs.png",
        "img/ace_of_spades.png", "img/ace_of_hearts.png", "img/ace_of_diamonds.png"];
    ...
    function removeCard(value) {
        nrCards--;
        cardsValue.splice(value, 1);
        cards.splice(value, 1);
    }

    function deal() {
        var drawnCards = 0;
        var value1 = Math.floor(Math.random() * nrCards);
        removeCard(value1);

        var value2 = Math.floor(Math.random() * nrCards);
        removeCard(value2);

        var tableCard1 = cardsValue[Math.floor(Math.random() * nrCards)];
        removeCard(tableCard1);
        var tableCard2 = cardsValue[Math.floor(Math.random() * nrCards)];
        removeCard(tableCard2);
        var tableCard3 = cardsValue[Math.floor(Math.random() * nrCards)];
        removeCard(tableCard3);
        var tableCard4 = cardsValue[Math.floor(Math.random() * nrCards)];
        removeCard(tableCard4);
        var tableCard5 = cardsValue[Math.floor(Math.random() * nrCards)];
        removeCard(tableCard5);
        ...
        value1 = Math.floor(Math.random() * nrCards);
        removeCard(value1);
        value2 = Math.floor(Math.random() * nrCards);
        removeCard(value2);
